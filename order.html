...
<body>
  <nav>
    <ul id="nav">
      ...
      <li>
        <a href="order.php" style="color: black" hover="color: #f2f2f2">Order</a>
      </li>
    </ul>
  </nav>
...
<footer>
  <li><img class="logo" id="footImg" src="images\Logo.png" alt="logo" style="height: 150px; width: auto; margin-right: 1rem;">Call us at: (123) 456 - 789</li>
</footer>
</footer>
</html>